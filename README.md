...
Legenda: ██ = execução (2ut) | █ = execução final (1ut)
...
### 🔧 Adicionar novas funcionalidades (ex: tempo de espera, turnaround time)
...
### Desenvolvido para disciplina de Sistemas Operacionais 🎓
